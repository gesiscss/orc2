...
By default, your minikube cluster will have a single node. To create a minikube cluster with more than one node, use the `--nodes` option. For example,
...
will create a minikube cluster with 3 nodes.
