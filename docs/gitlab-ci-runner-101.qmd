...
StartLimitBurst=10
ExecStart=/usr/local/bin/gitlab-runner "run" "--working-directory" "/home/username" "--config" "/home/iuser/.gitlab-runner/config.toml" "--service" "gitlab-runner-username" "--syslog" "--user" "username"
